...
(function (d) {
    ...
    function A(a, b, c, e) {
        ...
        b.message ===
        h && ("remove" === c ? (a = a.i18n[c].confirm, b.message = 1 !== e ? a._.replace(/%d/, e) : a["1"]) : b.message = "");
        return b
    }
    ...
    f.Field = function (a, b, c) {
        var e = this, j = c.i18n.multi, a = d.extend(!0, {}, f.Field.defaults, a);
        ...
        '">' + j.info + '</span></div><div data-dte-e="msg-multi" class="' + b.multiRestore + '">' + j.restore + '</div><div data-dte-e="msg-error" class="' + b["msg-error"] + '"></div><div data-dte-e="msg-message" class="' + b["msg-message"] + '"></div><div data-dte-e="msg-info" class="' + b["msg-info"] + '">' + a.fieldInfo + "</div></div></div>");
    ...
    f.Field.prototype = {
        ...
        hide: function (a) {
            ...
            if (a === h)for (var a = {}, e = 0; e < c.length; e++)a[c[e]] = this.isMultiValue() ? b[c[e]] : this.val(); else a = this.isMultiValue() ? b[a] : this.val();
            return a
        }, multiSet: function (a,
                               b) {
            var c = this.s.multiValues, e = this.s.multiIds;
            b === h && (b = a, a = h);
            var j = function (a, b) {
            ...
            if ((b === h || !0 === b) && "string" === typeof a)a = a.replace(/&gt;/g, ">").replace(/&lt;/g,
            ...
            d && this.s.multiValue ? (this.dom.inputControl.css({display: "none"}), this.dom.multi.css({display: "block"})) : (this.dom.inputControl.css({display: "block"}), this.dom.multi.css({display: "none"}), this.s.multiValue && this.val(a));
            b && 1 < b.length && this.dom.multiReturn.css({display: d && !this.s.multiValue ? "block" : "none"});
            ...
            var c = this.s.type[a];
            if (c)return c.apply(this.s.host,
                b)
        }
    };
    f.Field.models = {};
    ...
    f.display.lightbox = q.extend(!0,
        {}, f.models.displayController, {
            ...
            _show: function (a) {
                var b = m._dom;
                p.orientation !== h && q("body").addClass("DTED_Lightbox_Mobile");
                b.content.css("height", "auto");
                b.wrapper.css({top: -m.conf.offsetAni});
                q("body").append(m._dom.background).append(m._dom.wrapper);
                m._heightCalc();
                b.wrapper.stop().animate({opacity: 1, top: 0}, a);
                ...
                q("div.DTED_Lightbox_Content_Wrapper", b.wrapper).bind("click.DTED_Lightbox",
                    function (a) {
                        q(a.target).hasClass("DTED_Lightbox_Content_Wrapper") && m._dte.background()
                    });
                q(p).bind("resize.DTED_Lightbox", function () {
                    m._heightCalc()
                });
            ...
            _heightCalc: function () {
                var a = m._dom, b = q(p).height() - m.conf.windowPadding * 2 - q("div.DTE_Header", a.wrapper).outerHeight() - q("div.DTE_Footer", a.wrapper).outerHeight();
            ...
            _hide: function (a) {
                ...
                b.wrapper.stop().animate({opacity: 0, top: m.conf.offsetAni}, function () {
                    q(this).detach();
                    a()
                });
                ...
                q(p).unbind("resize.DTED_Lightbox")
            },
            _dte: null,
            _ready: !1,
            _shown: !1,
    ...
    f.display.envelope = l.extend(!0, {}, f.models.displayController, {
        init: function (a) {
            ...
            b.opacity = 0;
            b.display = "block";
            var c = g._findAttachRow(), e = g._heightCalc(), d = c.offsetWidth;
            b.display = "none";
            b.opacity = 1;
            g._dom.wrapper.style.width =
                d + "px";
            ...
            g._dom.background.style.display = "block";
            l(g._dom.background).animate({opacity: g._cssBackgroundOpacity}, "normal");
            l(g._dom.wrapper).fadeIn();
            g.conf.windowScroll ? l("html,body").animate({scrollTop: l(c).offset().top + c.offsetHeight - g.conf.windowPadding}, function () {
                l(g._dom.content).animate({top: 0}, 600, a)
            ...
            l(p).bind("resize.DTED_Envelope", function () {
                g._heightCalc()
            })
        }, _heightCalc: function () {
            g.conf.heightCalc ? g.conf.heightCalc(g._dom.wrapper) : l(g._dom.content).children().height();
            var a = l(p).height() - g.conf.windowPadding * 2 - l("div.DTE_Header", g._dom.wrapper).outerHeight() - l("div.DTE_Footer", g._dom.wrapper).outerHeight();
            l("div.DTE_Body_Content", g._dom.wrapper).css("maxHeight", a);
            return l(g._dte.dom.wrapper).outerHeight()
        }, _hide: function (a) {
            a || (a = function () {
            });
            l(g._dom.content).animate({top: -(g._dom.content.offsetHeight + 50)}, 600, function () {
            ...
            l(p).unbind("resize.DTED_Lightbox")
    ...
    f.prototype.bubble = function (a, b, c, e) {
        ...
        c === h && (c = !0);
        var e = d.extend({}, this.s.formOptions.bubble, e), o = this._dataSource("individual", a, b);
        this._edit(a, o, "bubble");
        if (!this._preopen("bubble"))return this;
        var f = this._formOptions(e);
        d(p).on("resize." + f, function () {
            j.bubblePosition()
        });
        var k = [];
        ...
        k = d('<div class="' + k.wrapper + '"><div class="' + k.liner + '"><div class="' +
        k.table + '"><div class="' + k.close + '" /></div></div><div class="' + k.pointer + '" /></div>');
        c && (k.appendTo("body"), o.appendTo("body"));
        var c = k.children().eq(0), w = c.children(), g = w.children();
    ...
    f.prototype.bubblePosition = function () {
        var a = d("div.DTE_Bubble"), b = d("div.DTE_Bubble_Liner"), c = this.s.bubbleNodes, e = 0, j = 0, o = 0, f = 0;
        ...
        var e = e / c.length, j = j / c.length, o = o / c.length, f = f / c.length, c = e, k = (j + o) / 2, w = b.outerWidth(), g = k - w / 2, w = g + w, h =
            d(p).width();
        a.css({top: c, left: k});
    ...
    f.prototype.clear = function (a) {
        ...
        "string" === typeof a ? (c[a].destroy(), delete c[a], a = d.inArray(a, this.s.order), this.s.order.splice(a, 1)) : d.each(this._fieldNames(a),
            function (a, c) {
                b.clear(c)
            });
        return this
    ...
    f.prototype.create = function (a, b, c, e) {
        var j = this, o = this.s.fields, f = 1;
        if (this._tidy(function () {
                j.create(a, b, c, e)
            }))return this;
    ...
    f.prototype.dependent = function (a, b, c) {
        var e = this, j = this.field(a), o = {type: "POST", dataType: "json"}, c = d.extend({
            event: "change",
            data: null,
            preUpdate: null,
            postUpdate: null
    ...
    f.prototype.inline = function (a, b, c) {
        ...
        var c = d.extend({}, this.s.formOptions.inline,
            c), j = this._dataSource("individual", a, b), f, n, k = 0, g, I = !1;
    ...
    f.prototype.remove = function (a, b, c, e, j) {
        ...
        a.length === h && (a = [a]);
        var n = this._crudArgs(b, c, e, j), k = this._dataSource("fields", a);
    ...
    f.prototype.submit = function (a, b, c, e) {
        var j = this, f = this.s.fields, n = [], k = 0, g = !1;
    ...
    f.error = function (a, b) {
        throw b ? a + " For more information, please refer to https://datatables.net/tn/" +
        b : a;
    };
    f.pairs = function (a, b, c) {
        var e, j, f, b = d.extend({label: "label", value: "value"}, b);
        if (d.isArray(a)) {
            e = 0;
    ...
    f.upload = function (a, b, c, e, j) {
        var o = new FileReader, n = 0, k = [];
        a.error(b.name, "");
        o.onload = function () {
            var g = new FormData, h;
            g.append("action", "upload");
            g.append("uploadField", b.name);
            g.append("upload",
                c[n]);
            b.ajaxData && b.ajaxData(g);
            if (b.ajax)h = b.ajax; else if ("string" === typeof a.s.ajax || d.isPlainObject(a.s.ajax))h = a.s.ajax;
            ...
            d.ajax(d.extend(h, {
                type: "post", data: g, dataType: "json", contentType: !1, processData: !1, xhr: function () {
                    ...
                    if (b.fieldErrors && b.fieldErrors.length)for (var b = b.fieldErrors, e = 0, g = b.length; e < g; e++)a.error(b[e].name, b[e].status); else b.error ? a.error(b.error) : (b.files && d.each(b.files, function (a, b) {
                        f.files[a] = b
    ...
    f.prototype._constructor = function (a) {
        ...
        this.dom = {
            wrapper: d('<div class="' + c.wrapper + '"><div data-dte-e="processing" class="' + c.processing.indicator + '"></div><div data-dte-e="body" class="' +
            c.body.wrapper + '"><div data-dte-e="body_content" class="' + c.body.content + '"/></div><div data-dte-e="foot" class="' + c.footer.wrapper + '"><div class="' + c.footer.content + '"/></div></div>')[0],
            ...
            header: d('<div data-dte-e="head" class="' +
            c.header.wrapper + '"><div class="' + c.header.content + '"/></div>')[0],
            buttons: d('<div data-dte-e="form_buttons" class="' + c.form.buttons + '"/>')[0]
        };
        if (d.fn.dataTable.TableTools) {
            var e = d.fn.dataTable.TableTools.BUTTONS, j = this.i18n;
    ...
    f.prototype._actionClass = function () {
        var a = this.classes.actions, b = this.s.action,
    ...
    f.prototype._ajax = function (a, b, c) {
        ...
        j = this.s.action;
        var f = this.s.ajax || this.s.ajaxUrl, n = "edit" === j || "remove" === j ? y(this.s.editFields, "idSrc") : null;
        ...
        if (d.isFunction(f)) {
            ...
            if (this.s.ajaxUrl) {
                ...
                h.create && (g = h[j]);
                -1 !== g.indexOf(" ") && (j = g.split(" "), e = j[0], g = j[1]);
                g = g.replace(/_id_/, n)
            }
            f(e, g, a, b, c)
        } else"string" === typeof f ? -1 !== f.indexOf(" ") ? (j = f.split(" "), e.type = j[0], e.url = j[1]) : e.url = f : e = d.extend({}, e, f || {}), e.url = e.url.replace(/_id_/, n), e.data && (c = d.isFunction(e.data) ? e.data(a) : e.data, a = d.isFunction(e.data) && c ? c : d.extend(!0, a, c)), e.data = a, "DELETE" === e.type && (a = d.param(e.data), e.url += -1 === e.url.indexOf("?") ? "?" + a : "&" + a, delete e.data),
            d.ajax(e)
    };
    ...
    f.prototype._clearDynamicInfo = function () {
        var a = this.classes.field.error, b = this.s.fields;
    ...
    f.prototype._edit = function (a, b, c) {
        ...
        for (var e = this.order().slice(), g =
            e.length; 0 <= g; g--)-1 === d.inArray(e[g], j) && e.splice(g, 1);
    ...
    f.prototype._eventName = function (a) {
        for (var b = a.split(" "), c = 0, e = b.length; c < e; c++) {
            ...
            d &&
            (a = d[1].toLowerCase() + a.substring(3));
            b[c] = a
        }
        return b.join(" ")
    };
    ...
    f.prototype._focus = function (a, b) {
        var c = this, e, j = d.map(a, function (a) {
    ...
    f.prototype._formOptions = function (a) {
        var b = this, c = M++, e = ".dteInline" + c;
        a.closeOnComplete !== h && (a.onComplete =
            a.closeOnComplete ? "close" : "none");
        ...
        d(r).on("keydown" + e, function (c) {
            var e = d(r.activeElement), f = e.length ? e[0].nodeName.toLowerCase() : null;
            d(e).attr("type");
    ...
    f.prototype._multiInfo = function () {
        var a = this.s.fields, b = this.s.includeFields, c = !0;
        if (b)for (var e = 0, d = b.length; e < d; e++)a[b[e]].isMultiValue() &&
        c ? (a[b[e]].multiInfoShown(c), c = !1) : a[b[e]].multiInfoShown(!1)
    };
    ...
    f.prototype._submit = function (a, b, c, e) {
        var f = this, g, n =
            !1, k = {}, w = {}, m = t.ext.oApi._fnSetObjectDataFn, l = this.s.fields, i = this.s.action, p = this.s.editCount, q = this.s.modifier, r = this.s.editFields, s = this.s.editData, u = this.s.editOpts, v = u.submit, x = {
        ...
        if ("create" === i || "edit" === i)if (d.each(r, function (a, b) {
                ...
                d.each(l, function (f, j) {
                    if (b.fields[f]) {
                        var g = j.multiGet(a), o = m(f), h = d.isArray(g) && f.indexOf("[]") !== -1 ? m(f.replace(/\[.*$/, "") + "-many-count") : null;
                        o(c, g);
                        h && h(c, g.length);
                        if (i ===
                            "edit" && g !== s[f][a]) {
            ...
            }), "create" === i || "all" === v || "allIfChanged" === v && n)x.data = k; else if ("changed" === v && n)x.data = w; else {
            this.s.action = null;
        ...
        !1 === this._event("preSubmit",
            [x, i]) ? this._processing(!1) : this._ajax(x, function (c) {
            var n;
            ...
            if (c.error || c.fieldErrors.length) {
                ...
                d.each(c.fieldErrors, function (a, b) {
                    ...
                    if (a === 0) {
                        d(f.dom.bodyContent, f.s.wrapper).animate({scrollTop: d(c.node()).position().top}, 500);
                        c.focus()
                    }
                });
                b && b.call(f, c)
                ...
                if (i === "create" || i ===
                    "edit")for (g = 0; g < c.data.length; g++) {
                    n = c.data[g];
            ...
            this.one("close", function () {
                if (b.s.processing)b.one("submitComplete",
                    function () {
                        ...
                        if (b.s.table && c.settings()[0].oFeatures.bServerSide)c.one("draw", a); else setTimeout(function () {
                            a()
                        }, 10)
    ...
    f.defaults = {
        ...
        i18n: {
            ...
            remove: {
                button: "Delete", title: "Delete", submit: "Delete",
        ...
        formOptions: {
            ...
            inline: d.extend({}, f.models.formOptions, {buttons: !1, submit: "changed"}),
    ...
    var J = function (a, b, c) {
        ...
        C = function (a, b) {
            ...
            b.rows(c).indexes().each(function (c) {
                var c = b.row(c), g = c.data(), k = d(g);
                k === h && f.error("Unable to find row identifier", 14);
                a[k] = {
                    idSrc: k, data: g,
                    node: c.node(), fields: e, type: "row"
                }
            })
        }, F = function (a, b, c, e, j, g) {
            b.cells(c).indexes().each(function (c) {
                var k = b.cell(c), i = b.row(c.row).data(), i = j(i), l;
                if (!(l = g)) {
                    l = c.column;
                    l = b.settings()[0].aoColumns[l];
                    var m = l.editField !== h ? l.editField : l.mData, p = {};
                    ...
                    d.isEmptyObject(p) && f.error("Unable to automatically determine field from source. Please specify the field name.",
                        11);
                    l = p
                }
                E(a, b, c.row, e, j);
    ...
    D.dataTable = {
        individual: function (a, b) {
            var c = t.ext.oApi._fnGetObjectDataFn(this.s.idSrc), e = d(this.s.table).DataTable(), f = this.s.fields, g = {}, h, k;
            ...
            var b = t.ext.oApi._fnGetObjectDataFn(this.s.idSrc),
                c = d(this.s.table).DataTable(), e = this.s.fields, f = {};
            ...
            if (!a.settings()[0].oFeatures.bServerSide) {
                var f =
                    t.ext.oApi._fnGetObjectDataFn(this.s.idSrc), g = f(c), b = a.row("#" + g);
            ...
            if ("edit" === a && e.rowIds.length)for (var f =
                e.rowIds, g = t.ext.oApi._fnGetObjectDataFn(this.s.idSrc), h = 0, e = f.length; h < e; h++)a = b.row("#" + f[h]), a.any() || (a = b.row(function (a, b) {
                return f[h] === g(b)
            })), a.any() && a.remove();
    ...
    D.html = {
        initField: function (a) {
            ...
            var c = D.html.fields.call(this, a), e = this.s.fields, f = {};
            d.each(b, function (a, b) {
                f[b] = e[b]
            });
            ...
            b[a] = {
                idSrc: a,
                data: c, node: r, fields: e, type: "row"
            };
            return b
        }, create: function (a, b) {
            if (b) {
    ...
    if (t.TableTools) {
        var i = t.TableTools.BUTTONS, G = {sButtonText: null, editor: null, formTitle: null};
        i.editor_create = d.extend(!0, i.text, G, {
            formButtons: [{
                label: null,
                fn: function () {
                    this.submit()
                ...
                var c = b.editor, e = c.i18n.create, d = b.formButtons;
                if (!d[0].label)d[0].label = e.submit;
                c.create({title: e.title, buttons: d})
            }
        });
        i.editor_edit = d.extend(!0, i.select_single, G, {
            formButtons: [{
                ...
                if (c.length === 1) {
                    var e = b.editor, d = e.i18n.edit, f = b.formButtons;
                    if (!f[0].label)f[0].label = d.submit;
                    e.edit(c[0], {title: d.title, buttons: f})
                }
            }
        });
        i.editor_remove = d.extend(!0, i.select,
            G, {
                question: null, formButtons: [{
                    ...
                    var c = this.fnGetSelectedIndexes();
                    if (c.length !== 0) {
                        var e = b.editor, d = e.i18n.remove, f = b.formButtons, g = typeof d.confirm === "string" ? d.confirm : d.confirm[c.length] ? d.confirm[c.length] : d.confirm._;
                        if (!f[0].label)f[0].label = d.submit;
    ...
    d.extend(t.ext.buttons,
        {
            ...
            editor: null, formButtons: {
                ...
                var a = e.editor, c = b.rows({selected: !0}).indexes(), d = b.columns({selected: !0}).indexes(), b = b.cells({selected: !0}).indexes();
                a.edit(d.length || b.length ? {rows: c, columns: d, cells: b} : c, {
                    message: e.formMessage,
                    buttons: e.formButtons,
            ...
            className: "buttons-remove", editor: null, formButtons: {
                ...
                var c = b.rows({selected: !0}).indexes(), e = a.i18n.remove;
                ...
                a = e.editor;
                a.remove(b.rows({selected: !0}).indexes(), {
                    buttons: e.formButtons,
                    message: e.formMessage,
    ...
    f.DateTime = function (a, b) {
        ...
        var c = this.c.classPrefix, e = this.c.i18n;
        if (!p.moment && "YYYY-MM-DD" !== this.c.format)throw"Editor datetime: Without momentjs only the format 'YYYY-MM-DD' can be used";
        var g = function (a) {
    ...
    d.extend(f.DateTime.prototype, {
        destroy: function () {
            ...
            if (a instanceof Date)this.s.d = this._dateToUtc(a); else if (null === a || "" ===
                a)this.s.d = null; else if ("string" === typeof a)if ("YYYY-MM-DD" === this.c.format) {
                var c = a.match(/(\d{4})\-(\d{2})\-(\d{2})/);
                this.s.d = c ? new Date(Date.UTC(c[1], c[2] - 1, c[3])) : null
            } else c = p.moment.utc(a, this.c.format, this.c.momentLocale, this.c.momentStrict), this.s.d = c.isValid() ? c.toDate() : null;
            ...
            var a =
                this, b = this.c.classPrefix, c = this.c.i18n;
            ...
            d(p).off("." + a);
            d(r).off("keydown." + a);
            d("div.DTE_Body_Content").off("scroll." +
            a);
            d("body").off("click." + a)
            ...
            var c =
                new Date, e = this._daysInMonth(a, b), f = (new Date(Date.UTC(a, b, 1))).getUTCDay(), g = [], h = [];
            0 < this.c.firstDay && (f -= this.c.firstDay, 0 > f && (f += 7));
            for (var k = e + f, i = k; 7 < i;)i -= 7;
            var k = k + (7 - i), i = this.c.minDate, l = this.c.maxDate;
            ...
            for (var m = 0, p = 0; m < k; m++) {
                var q = new Date(Date.UTC(a, b, 1 + (m - f))), r = this.s.d ? this._compareDates(q, this.s.d) : !1, s = this._compareDates(q, c), t = m < f || m >= e + f, u = i && q < i || l && q > l, v = this.c.disableDays;
            ...
            var a =
                [], b = this.c.firstDay, c = this.c.i18n, e = function (a) {
                for (a += b; 7 <= a;)a -= 7;
                return c.weekdays[a]
            };
            ...
            var e = new Date(c, 0, 1), a = Math.ceil(((new Date(c, b, a) - e) / 864E5 + e.getUTCDay() + 1) / 7);
            return '<td class="' + this.c.classPrefix + '-week">' + a + "</td>"
        }, _options: function (a, b, c) {
            c || (c = b);
            a = this.dom.container.find("select." + this.c.classPrefix + "-" + a);
            a.empty();
            for (var e = 0, d = b.length; e <
            d; e++)a.append('<option value="' + b[e] + '">' + c[e] + "</option>")
        }, _optionSet: function (a, b) {
            var c = this.dom.container.find("select." + this.c.classPrefix + "-" + a), e = c.parent().children("span");
            c.val(b);
            c = c.find("option:selected");
            e.html(0 !== c.length ? c.text() : this.c.i18n.unknown)
        }, _optionsTime: function (a, b, c) {
            var a = this.dom.container.find("select." + this.c.classPrefix + "-" + a), e = 0, d = b, f = 12 === b ? function (a) {
                return a
            } : this._pad;
            12 === b && (e = 1, d = 13);
        ...
        _optionsTitle: function () {
            var a = this.c.i18n, b = this.c.minDate, c = this.c.maxDate, b = b ? b.getFullYear() : null, c = c ? c.getFullYear() : null, b = null !== b ? b : (new Date).getFullYear() - this.c.yearRange, c = null !== c ? c : (new Date).getFullYear() + this.c.yearRange;
            ...
            var e = b.outerHeight(), f = d("body").scrollTop();
            a.top + c + e - f > d(p).height() && (a = a.top - e, b.css("top", 0 > a ? 0 : a))
        }, _range: function (a, b) {
            ...
            this.s.parts.hours12 ?
                (this._optionSet("hours", this._hours24To12(b)), this._optionSet("ampm", 12 > b ? "am" : "pm")) : this._optionSet("hours", b);
            ...
            var b = this.s.d, b = "YYYY-MM-DD" === this.c.format ? b.getUTCFullYear() + "-" + this._pad(b.getUTCMonth() + 1) + "-" + this._pad(b.getUTCDate()) : p.moment.utc(b, h, this.c.momentLocale, this.c.momentStrict).format(this.c.format);
    ...
    var H = function (a, b) {
        ...
        var e = a.classes.form.button, e = d('<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload"><button class="' + e + '" /><input type="file"/></div><div class="cell clearValue"><button class="' +
        e + '" /></div></div><div class="row second"><div class="cell"><div class="drop"><span/></div></div><div class="cell"><div class="rendered"/></div></div></div></div>');
        b._input = e;
        b._enabled = !0;
        H(b);
        if (p.FileReader && !1 !== b.dragDrop) {
        ...
        e.find("input[type=file]").on("change", function () {
            f.upload(a, b, this.files,
                H, c)
        });
        return e
    }, B = function (a) {
        setTimeout(function () {
            a.trigger("change", {editorSet: !0})
        }, 0)
    }, s = f.fieldTypes, i = d.extend(!0, {}, f.models.fieldType, {
        get: function (a) {
            return a._input.val()
        }, set: function (a, b) {
            a._input.val(b);
    ...
    s.readonly = d.extend(!0, {}, i, {
        create: function (a) {
            a._input =
                d("<input/>").attr(d.extend({id: f.safeId(a.id), type: "text", readonly: "readonly"}, a.attr || {}));
            return a._input[0]
        }
    });
    s.text = d.extend(!0, {}, i, {
        create: function (a) {
            a._input = d("<input/>").attr(d.extend({id: f.safeId(a.id), type: "text"}, a.attr || {}));
            return a._input[0]
        }
    });
    s.password = d.extend(!0, {}, i, {
        create: function (a) {
            a._input = d("<input/>").attr(d.extend({id: f.safeId(a.id), type: "password"}, a.attr || {}));
            return a._input[0]
        }
    });
    s.textarea = d.extend(!0, {}, i, {
        create: function (a) {
            a._input = d("<textarea/>").attr(d.extend({id: f.safeId(a.id)},
                a.attr || {}));
            return a._input[0]
        }
    });
    s.select = d.extend(!0, {}, i, {
        _addOptions: function (a, b) {
            var c = a._input[0].options, e = 0;
            c.length = 0;
            if (a.placeholder !== h) {
                e = e + 1;
            ...
            a._input = d("<select/>").attr(d.extend({
                id: f.safeId(a.id), multiple: a.multiple ===
                true
            }, a.attr || {}));
            s.select._addOptions(a, a.options || a.ipOpts);
            return a._input[0]
        }, update: function (a, b) {
            var c = s.select.get(a), e = a._lastSet;
            ...
            var b = a.multiple && a.separator && !d.isArray(b) ? b.split(a.separator) : [b],
                e, f = b.length, g, h = false, c = a._input.find("option");
    ...
    s.checkbox = d.extend(!0, {}, i, {
        _addOptions: function (a, b) {
            ...
            c.each(function () {
                g = false;
                for (e =
                         0; e < f; e++)if (this._editor_val == b[e]) {
                    g = true;
                    break
                }
                this.checked = g
            ...
            var c = s.checkbox, e = c.get(a);
            c._addOptions(a, b);
            c.set(a, e)
        }
    });
    s.radio = d.extend(!0, {}, i, {
        _addOptions: function (a, b) {
            var c = a._input.empty();
            b && f.pairs(b, a.optionsPair, function (b, g, h) {
                c.append('<div><input id="' + f.safeId(a.id) + "_" + h + '" type="radio" name="' + a.name + '" /><label for="' +
                f.safeId(a.id) + "_" + h + '">' + g + "</label></div>");
                d("input:last", c).attr("value", b)[0]._editor_val = b
            })
        }, create: function (a) {
            a._input = d("<div />");
            ...
            a._input.find("input").each(function () {
                ...
                if (this._editor_val == b)this._preChecked =
                    this.checked = true; else this._preChecked = this.checked = false
            });
    ...
    s.date = d.extend(!0, {}, i, {
        create: function (a) {
            a._input = d("<input />").attr(d.extend({id: f.safeId(a.id), type: "text"},
                a.attr));
            if (d.datepicker) {
            ...
            d.datepicker && a._input.hasClass("hasDatepicker") ? a._input.datepicker("setDate",
                b).change() : d(a._input).val(b)
        }, enable: function (a) {
    ...
    s.datetime = d.extend(!0, {}, i, {
        create: function (a) {
            a._input = d("<input />").attr(d.extend(true, {id: f.safeId(a.id), type: "text"}, a.attr));
            a._picker =
                new f.DateTime(a._input, d.extend({format: a.format, i18n: this.i18n.datetime}, a.opts));
            return a._input[0]
        }, set: function (a, b) {
            a._picker.val(b);
            B(a._input)
    ...
    s.uploadMany = d.extend(!0, {}, i, {
        create: function (a) {
            var b = this, c = L(b, a, function (c) {
